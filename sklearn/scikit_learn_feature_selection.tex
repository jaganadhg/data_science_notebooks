...
\subsubsection{Combining Multiple Feature Selection (Feature Union)}

Sklearn provides a handly utility to combine various feature selection
techniques applied above. This is facilitated through the FeatureUnion
API. Let's see how FeatureUnion is working.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}19}]:} \PY{k+kn}{import} \PY{n+nn}{pandas} \PY{k+kn}{as} \PY{n+nn}{pd}
         
         \PY{k+kn}{from} \PY{n+nn}{sklearn.pipeline} \PY{k+kn}{import} \PY{n}{FeatureUnion}
         ...
         \PY{k}{def} \PY{n+nf}{feature\PYZus{}union}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{y}\PY{p}{)}\PY{p}{:}
             \PY{l+s+sd}{\PYZdq{}\PYZdq{}\PYZdq{}}
         \PY{l+s+sd}{    Apply feature union with PCA and SelectKBest}
         \PY{l+s+sd}{    :param X: pandas DataFrame with attributes}
         \PY{l+s+sd}{    :param y: pandas Series with target variable}
         \PY{l+s+sd}{    :returns new\PYZus{}feats: pandas DataFrame with new features}
         \PY{l+s+sd}{    \PYZdq{}\PYZdq{}\PYZdq{}}
             
             \PY{n}{pca} \PY{o}{=} \PY{n}{PCA}\PY{p}{(}\PY{n}{n\PYZus{}components}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{)}
             \PY{n}{kbest} \PY{o}{=} \PY{n}{SelectKBest}\PY{p}{(}\PY{n}{k}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{)}
             \PY{n}{f\PYZus{}union} \PY{o}{=} \PY{n}{FeatureUnion}\PY{p}{(}\PY{p}{[}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{pca}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{pca}\PY{p}{)}\PY{p}{,} \PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{kbest}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{n}{kbest}\PY{p}{)}\PY{p}{]}\PY{p}{)}
             \PY{n}{selected\PYZus{}feat} \PY{o}{=} \PY{n}{f\PYZus{}union}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{y}\PY{p}{)}\PY{o}{.}\PY{n}{transform}\PY{p}{(}\PY{n}{X}\PY{p}{)}
             
             \PY{n}{new\PYZus{}feats} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{n}{selected\PYZus{}feat}\PY{p}{)}
             \PY{n}{new\PYZus{}feats}\PY{p}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{target}\PY{l+s}{\PYZdq{}}\PY{p}{]} \PY{o}{=} \PY{n}{y}
             
             \PY{k}{return} \PY{n}{new\PYZus{}feats}
         
         \PY{n}{iris} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{/resources/iris.csv}\PY{l+s}{\PYZdq{}}\PY{p}{)}
         
         \PY{n}{Y} \PY{o}{=} \PY{n}{iris}\PY{p}{[}\PY{l+s}{\PYZdq{}}\PY{l+s}{Class}\PY{l+s}{\PYZdq{}}\PY{p}{]}
         \PY{n}{X} \PY{o}{=} \PY{n}{iris}\PY{o}{.}\PY{n}{drop}\PY{p}{(}\PY{l+s}{\PYZdq{}}\PY{l+s}{Class}\PY{l+s}{\PYZdq{}}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
         \PY{n}{new\PYZus{}f} \PY{o}{=} \PY{n}{feature\PYZus{}union}\PY{p}{(}\PY{n}{X}\PY{p}{,}\PY{n}{Y}\PY{p}{)}
         
         \PY{n}{new\PYZus{}f}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
